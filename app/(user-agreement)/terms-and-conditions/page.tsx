    ...
    <div>
      <div>
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            By accepting these Terms of Service, users confirm they are of legal
            age or have obtained consent from a legal guardian for any minor
            dependents. Products must not be used for illegal or unauthorized
            purposes, and any violation will result in immediate service
            termination.
          </p>
          ...
          <p className="mb-4">
            The company reserves the right to refuse service to anyone at any
            time. Users understand that content may be transferred unencrypted,
            and any unauthorized reproduction or exploitation of the service is
          ...
          <p className="mb-4">
            ...
            timeliness of information on the site. Users should use the material
            for general information only and consult more accurate and timely
          ...
          <p className="mb-4">
            ...
            notice. The company reserves the right to modify or discontinue the
            service without notice. The company is not liable for any
            modifications, price changes, or discontinuation of the service or
            product.
          </p>
          ...
          <h2 className="text-2xl font-bold mb-2">Products or Services</h2>

          <p className="mb-4">
            Certain products or services may be exclusively available online,
            with limited quantities and subject to return or exchange as per the
            Return Policy. Efforts are made to accurately display product colors
            and images, but accuracy is not guaranteed.
          </p>
          ...
          <p className="mb-4">
            The company reserves the right to refuse any order, limit or cancel
            quantities, and change or discontinue products or services. Users
            must provide current, complete, and accurate purchase and account
            information.
          </p>
          ...
          <p className="mb-4">
            Certain content, products, and services may include third-party
            materials. Third-party links are not affiliated with the company,
            which is not responsible for third-party materials or websites.
          </p>
          ...
          <p className="mb-4">
            By submitting comments, users grant the company the right to edit,
            copy, publish, and distribute them. The company may monitor, edit,
            or remove content deemed unlawful, offensive, or violating
          ...
          <p className="mb-4">
            The company may correct errors, inaccuracies, or omissions without
            notice. Users are responsible for monitoring changes.
          </p>

          <h2 className="text-2xl font-bold mb-2">Prohibited Uses</h2>
          ...
          <h2 className="text-2xl font-bold mb-2">Disclaimer of Warranties; Limitation of Liability</h2>
          ...
          For questions about the terms of service, users can contact the company at devmart.team@gmail.com.
          </p>
